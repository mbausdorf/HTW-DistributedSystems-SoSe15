...
public final class ChessTableBoardTemplate extends ChessTableBoard {
	 ...
	 */
	public ChessTableBoardTemplate (final byte rankCount, final byte fileCount, final short moveClock, final short reversibleMoveClock) {
	 ...
	 */
	public ChessTableBoardTemplate (final char[][] pieceMatrix, final short moveClock, final short reversibleMoveClock, final boolean[] castlingAbilities, byte[] passingPawnCoordinates) {
