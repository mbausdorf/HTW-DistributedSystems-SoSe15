...
/**
 * Interactive command line client utilizing the JAX-WS shop service. Note that the client
 * terminates after typing "quit". Note that this class is declared final because it provides an
...
public final class ShopClient2 {
	...
	/**
	 * Application entry point. The given runtime parameters must be a service URI, an alias, and a
	 * password.
	...
	static public void main (final String[] args) throws IOException {
		...
		for (String line = charSource.readLine(); line != null && !line.equals("quit"); line = charSource.readLine()) {
			try {
				...
				switch (command) {
					...
					case REGISTER_CUSTOMER: {
						...
						customer.setGivenName(words[1]);
						customer.setFamilyName(words[2]);
						...
						final long customerIdentity = serviceProxy.registerCustomer(customer, password);
