...
Script: quick-xml.js
        ...
        to the popular built-in JSON singleton. Note that having no global object
        at all would be preferable in a larger project context, but as of today
        there is no built-in library support for neither namespaces nor modules in
        JavaScript; therefore, in order not to require another dependency, we won't
        bother with namespaces or modules here, and hope the name "QUICK_XML" is
        stupid enough to avoid naming conflicts.
