 ...
 * blocking method. Additionally demonstrates process I/O redirection, and a situationally correct
...
public final class ResyncProcessByBlocking {
	...
	static public void main (final String[] args) throws IOException {
		...
		try {
			...
			// CHOSING to handle the interruption by ending this process - see class comment!
			...
			System.out.println("Before-after relationship broken because resynchronization was interrupted, aborting parent process!");
			System.exit(1);
		}
	}
}